                   ...
                   child: Column(
                      children: <Widget>[
                        Align(
                          ...
                          child: Text(pet.name, style: TextStyle(color: colorPetCare, fontSize: 20.0, fontWeight: FontWeight.bold))
                        ),
                        SizedBox(height: 20),
                        Align(
                          alignment: Alignment.bottomLeft,
                          child: Text(pet.breed, style: TextStyle(color: colorPetCare, fontSize: 20.0, fontWeight: FontWeight.bold)),

                        ),
                        SizedBox(height: 20),
                        Align(
                          alignment: Alignment.bottomLeft,
                          child:Text(pet.age.toString() + ' años', style: TextStyle(color: colorPetCare, fontSize: 20.0, fontWeight: FontWeight.bold)),

                        ),
                        SizedBox(height: 20),
                        Align(
                          alignment: Alignment.bottomLeft,
                          child:Text(pet.gender + 'acho', style: TextStyle(color: colorPetCare, fontSize: 20.0, fontWeight: FontWeight.bold))
